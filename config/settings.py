...
RATE_LIMIT_STOCK_COST_PER_HOUR = int(_env('RATE_LIMIT_STOCK_COST_PER_HOUR', '8') or '8')
RATE_LIMIT_STOCK_COST_VIEW_PER_MINUTE = int(
    _env('RATE_LIMIT_STOCK_COST_VIEW_PER_MINUTE', '60') or '60'
)
