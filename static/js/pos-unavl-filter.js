(function () {
  ...
  var branchEl = document.getElementById('pos-unavl-branch');
  var whEl = document.getElementById('pos-unavl-wh');
  var dataEl = document.getElementById('pos-unavl-wh-data');
