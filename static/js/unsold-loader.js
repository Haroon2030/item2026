(function () {
  ...
  var wrap = document.getElementById('us-returns-wrap');
  var table = document.getElementById('us-items-table');
  var tbody = document.getElementById('us-items-body');
  var loader = document.getElementById('us-loader');
  var countEl = document.getElementById('us-loaded-count');
  ...
  function buildRow(row, index) {
    ...
    tr.innerHTML =
      ...
      '<td class="pr-wh" title="' + esc(row.warehouse_name) + '">' +
        esc(row.warehouse_code) + ' — ' + esc(row.warehouse_name) + '</td>' +
      ...
      '<td class="mono pr-col-amt">' + esc(row.net_display) + '</td>';
    return tr;
  }
